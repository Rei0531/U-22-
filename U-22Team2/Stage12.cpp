...
int Stage12(void) {			//マップ画像の描画
	...
	Change(LIGHTBLUE);
	DrawExtendGraph(400, 568, 500, 668, g_pic.Box[0], TRUE);	//1
	DrawExtendGraph(400, 468, 500, 568, g_pic.Box[0], TRUE);	//2
	...
	Change(LIGHTBLUE);
	DrawExtendGraph(500, 368, 600, 468, g_pic.Box[0], TRUE);	//3
